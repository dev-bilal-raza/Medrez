...
const socket = io('https://medrezserver-lake.vercel.app'); // Connect to the server
...
function Dashboard() {
  ...
  const fetchAnnualRotationData = async () => {
    try {
      const response = await fetch('https://medrezserver-lake.vercel.app/api/schedules');
  ...
  const fetchShiftScheduleData = async () => {
    try {
      const response = await fetch('https://medrezserver-lake.vercel.app/api/shift-schedules');
      const data = await response.json();
  ...
  useEffect(() => {
    const fetchNotifications = async () => {
      const response = await fetch('https://medrezserver-lake.vercel.app/api/notifications');
      const data = await response.json();
  ...
  const handleDeleteSchedule = async (id) => {
    if (window.confirm("Are you sure you want to delete this schedule?")) {
      try {
        const response = await fetch(`https://medrezserver-lake.vercel.app/api/rotations/${id}`, {
          method: 'DELETE',
        });
  ...
  const openTrash = async () => {
    try {
      const response = await fetch('https://medrezserver-lake.vercel.app/api/trashed-schedules'); // Fetch trashed schedules from the server
      const data = await response.json();
