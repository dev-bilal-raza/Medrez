...
function SettingsPage() {
    ...
    const handleSave = async () => {
        try {
            const response = await axios.post('https://medrezserver-lake.vercel.app/api/publishing-settings', {
                institutionName,
                departmentName,
                isSearchable,
                extraSearchTerms,
    ...
    return (
        <Layout>
            <div className="flex flex-col">
                <div className='w-full flex justify-between p-4 px-6 bg-[#F5F5F5]'>
                ...
                <div className='p-6'>
                    <div className="grid grid-cols-3 gap-8">
                        <div className="col-span-2">
                            ...
                            <div className={`border-2 border-gray-300 rounded-md p-4 ${enablePublishing ? 'bg-[#F4F4F4]' : 'bg-gray-200'}`}>
                                <div className="mb-4">
                        ...
                        <div className="space-y-6">
                            <div className="bg-yellow-100 p-4 space-y-3 rounded-md">
                            ...
                            <div className="bg-yellow-100 space-y-3 p-4 rounded-md">
