...
function CallShiftBlock() {
  ...
  useEffect(() => {
    const fetchShifts = async () => {
      try {
        const response = await axios.get("https://medrezserver-lake.vercel.app/api/shifts");
  ...
  const handleAddShiftRow = async (newShift) => {
    try {
      const response = await axios.post("https://medrezserver-lake.vercel.app/api/shifts", newShift);
  ...
  const handleDeleteShift = async (shiftId) => {
    try {
      await axios.delete(`https://medrezserver-lake.vercel.app/api/shifts/${shiftId}`);
