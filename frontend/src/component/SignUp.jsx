  ...
  return (
    <div className="grid sm:grid-cols-2">
      <div className="hidden sm:block">
        <img src={SignupImage} className="h-full object-cover" alt="Signup" />
      </div>
      <div className="py-8 px-16">
        ...
        <div className="xl:w-[80%] flex flex-col gap-3 my-3">
          <h1 className="text-[#010F2D] font-heading font-semibold text-4xl  sm:text-3xl md:text-5xl py-3">Create new Account!</h1>
        ...
        <form onSubmit={handleSubmit}>
          <div className="flex flex-col w-[80%] gap-2 mb-4 mt-3">
            <label className="text-[#010F2D] font-medium font-para text-base">Username</label>
            <input
              type="text"
              name="username"
          ...
          <div className="flex flex-col w-[80%] gap-2 mb-4 mt-3">
            <label className="text-[#010F2D] font-medium text-base md:text-lg">Email Address</label>
            <input
              type="email"
              name="email"
              className="border-2 p-2 py-3 rounded-md bg-[#E8F0FE] focus:outline-none focus:ring-2 focus:ring-[#11BE79]"
          ...
          <div className="flex flex-col w-[80%] gap-2 mb-4 mt-3">
            <label className="text-[#010F2D] font-medium font-para text-base">Select Role</label>
            <select
              name="role"
              value={formData.role}
              onChange={handleChange}
              className="cursor-pointer border-2 p-2 py-3 rounded-md bg-[#E8F0FE] focus:outline-none focus:ring-2 focus:ring-[#11BE79]"
              required
            >
